...
designed to find the significant interactions from a given sample of Hi-C reads. HiSIF was implemented by using C++/C with parallel processing being written in C. It has been compiled and run exclusively 
...
supports all of the available three Hi-C protocols (Hi-C, TCC and in situ Hi-C).
